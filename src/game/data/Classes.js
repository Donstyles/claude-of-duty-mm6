...
const CLASS_LIST = [
  // ── Knight line ──────────────────────────────────────────────────────────
  {
    ...
    description: 'A sworn sword of the Chapter. Knights never touch a spellbook and never need to — nothing else in Caerwen wears full plate and swings a great axe with the same skill.',
    ...
    promotion: {
      ...
      summary: 'Prove yourself to the Sword Chapter by emptying the goblin warren under the Old Watch.',
    },
  },
  {
    ...
    promotion: {
      ...
      summary: 'Win the Champion\'s Trial in the Ashford muster yard against three named challengers, one after another.',
    },
  },
  {
    ...
    promotion: {
      ...
      giver: 'npc_warden_malveth', location: 'netherby_moors',
      requiredLevel: 25, fee: 0,
      requiredSkills: [{ skill: 'armsmaster', mastery: G }, { skill: 'plate', mastery: G }],
      summary: 'Take the black harness out of the hole under the Netherhall and answer for what wearing it costs you.',
    },
  },
  {
    ...
    description: 'The oath is inverted but not broken. Black Knights are feared in every town in Caerwen, and priced accordingly by every shopkeeper.',
  ...
  // ── Paladin line ─────────────────────────────────────────────────────────
  {
    ...
    promotion: {
      ...
      giver: 'npc_bettany_roon', location: 'the_cindermoor',
      requiredLevel: 6, fee: 0,
      requiredSkills: [{ skill: 'spirit', mastery: E }, { skill: 'shield', mastery: E }],
      summary: 'Cleanse the wayside lamp on the Cindermoor road of the penitents squatting in it, without burning it down.',
    },
  },
  {
    ...
    description: 'Sworn to carry the fight rather than hold the wall. Crusaders travel light and hit Choir shrines hard.',
    ...
    promotion: {
      ...
      giver: 'npc_bettany_roon', location: 'coldwater_sound',
      requiredLevel: 15, fee: 0,
  ...
  },
  {
    ...
    baseSP: 18, spPerLevel: 2, spStat: 'personality', spStatFactor: 1,
    startingStats: { might: 20, intellect: 5, personality: 20, endurance: 15, accuracy: 12, speed: 7, luck: 7 },
    skills: { ...PALADIN_SKILLS, spirit: G, mind: M, body: G, sword: G, mace: G, diplomacy: G },
    startingSkills: ['sword', 'leather', 'spirit'],
    promotion: {
      to: 'villain', title: 'Villain', quest: 'promo_villain',
      giver: 'npc_precentor_vane', location: 'duskorn_waste',
      requiredLevel: 25, fee: 0,
      requiredSkills: [{ skill: 'spirit', mastery: G }, { skill: 'mace', mastery: G }],
      summary: 'Sell the name you built. Give the Choir Hall what it asks for, and learn what it buys.',
    },
  },
  {
    id: 'villain', name: 'Villain', base: 'paladin', tier: 3,
    promotesTo: [],
    role: 'Final Paladin form. Enormous spell points, and every lamp house in Caerwen doubles its prices.',
  ...
  // ── Archer line ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Trained on the vale marches, where a longbow and a fire bolt are considered the same tool used at different ranges.',
    ...
    promotion: {
      ...
      giver: 'npc_neve_harrow', location: 'thornwick_vale',
      requiredLevel: 6, fee: 0,
      requiredSkills: [{ skill: 'bow', mastery: E }, { skill: 'air', mastery: E }],
      summary: 'Recover the old Marchwarden\'s bow from the dragonfly nests in the Saltmarch channels.',
    },
  },
  {
  ...
  },
  {
    ...
    baseSP: 20, spPerLevel: 3, spStat: 'intellect', spStatFactor: 1,
    startingStats: { might: 15, intellect: 15, personality: 5, endurance: 12, accuracy: 20, speed: 12, luck: 7 },
    ...
    promotion: {
      ...
      summary: 'Put an arrow through the eye of the wyrm taking the Malveth flocks — from the ground, alone.',
    },
  },
  {
    ...
    description: 'There is a shot in the Malveth ballads that nobody has repeated. This is the discipline that made it.',
  ...
  // ── Druid line ───────────────────────────────────────────────────────────
  {
    ...
    description: 'The old faith of the Weald. A druid answers every problem, eventually, but rarely with the strongest possible answer.',
    hitDie: 6, baseHP: 14, hpPerLevel: 3, enduranceFactor: 1,
    baseSP: 15, spPerLevel: 2, spStat: 'mixed', spStatFactor: 1,
    ...
    promotion: {
      ...
      giver: 'npc_alys_bracken', location: 'gallowfen',
      requiredLevel: 8, fee: 0,
      requiredSkills: [{ skill: 'earth', mastery: E }, { skill: 'alchemy', mastery: E }],
      summary: 'Restore the blighted holt in the Gallowfen by brewing the antidote from four reagents the fen does not want to give up.',
    },
  },
  {
    ...
    baseSP: 24, spPerLevel: 3, spStat: 'mixed', spStatFactor: 1,
    startingStats: { might: 5, intellect: 20, personality: 20, endurance: 15, accuracy: 7, speed: 12, luck: 7 },
    skills: { ...DRUID_SKILLS, spirit: M, mind: M, body: M },
    startingSkills: ['staff', 'leather', 'earth'],
    promotion: {
      to: 'arch_druid', title: 'Arch Druid', quest: 'promo_arch_druid',
      giver: 'npc_alys_bracken', location: 'verdant_weald',
      requiredLevel: 20, fee: 0,
      requiredSkills: [{ skill: 'earth', mastery: M }, { skill: 'meditation', mastery: M }],
      summary: 'Stand the vigil at the Greenheart in the Verdant Weald for a full day and night without casting a single spell.',
    },
  },
  {
    ...
    description: 'The circle answers to them, and so, on a good day, does the weather over half of Caerwen.',
    hitDie: 8, baseHP: 24, hpPerLevel: 5, enduranceFactor: 2,
    baseSP: 34, spPerLevel: 4, spStat: 'mixed', spStatFactor: 2,
    startingStats: { might: 5, intellect: 20, personality: 20, endurance: 15, accuracy: 7, speed: 12, luck: 7 },
    skills: {
  ...
  // ── Cleric line ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Ordained in the Order of the Kindled Lamp. A cleric keeps three other people alive and hits things with a blunt object when that fails.',
    hitDie: 6, baseHP: 15, hpPerLevel: 3, enduranceFactor: 1,
    baseSP: 15, spPerLevel: 2, spStat: 'personality', spStatFactor: 1,
    ...
    promotion: {
      ...
      giver: 'npc_sister_elin', location: 'greywater_fen',
      requiredLevel: 8, fee: 0,
      requiredSkills: [{ skill: 'body', mastery: E }, { skill: 'spirit', mastery: E }],
      summary: 'Carry the rites out to the fever villages in the Greywater and bring back everyone who can still walk.',
    },
  },
  {
    ...
    description: 'A full priest of the Lamp. From here the road forks, and the fork is not reversible.',
    hitDie: 6, baseHP: 19, hpPerLevel: 4, enduranceFactor: 1,
    baseSP: 24, spPerLevel: 3, spStat: 'personality', spStatFactor: 1,
    startingStats: { might: 12, intellect: 5, personality: 30, endurance: 13, accuracy: 7, speed: 12, luck: 7 },
      ...
      alternatives: [
        {
          ...
          summary: 'Descend into the Choir Hall beneath Duskorn and take the Dark Rite from whatever is holding it.',
        },
      ],
      giver: 'npc_tamsin_ashe', location: 'the_cindermoor',
      requiredLevel: 20, fee: 0,
      requiredSkills: [{ skill: 'spirit', mastery: G }, { skill: 'body', mastery: M }],
      summary: 'Relight the font at the Kindled Shrine on the Cindermoor, which has been cold for twenty years.',
    },
  },
  {
    ...
    description: 'The Long Hour, Day of Protection, and at the very top, Divine Intervention. Light is the most expensive school in Caerwen for a reason.',
    hitDie: 8, baseHP: 24, hpPerLevel: 5, enduranceFactor: 2,
    baseSP: 34, spPerLevel: 4, spStat: 'personality', spStatFactor: 2,
    startingStats: { might: 12, intellect: 5, personality: 30, endurance: 13, accuracy: 7, speed: 12, luck: 7 },
  ...
  },
  {
    ...
    promotesTo: [],
    role: 'Final Cleric form (Dark). Grandmaster Dark Magic — Armageddon, Soul Reave, and no welcome in any lamp house.',
    description: 'The Dark Rite took, and something answered. Priests of Dark heal as well as they ever did; nobody is comfortable about it.',
    hitDie: 8, baseHP: 24, hpPerLevel: 5, enduranceFactor: 2,
    baseSP: 34, spPerLevel: 4, spStat: 'personality', spStatFactor: 2,
    startingStats: { might: 12, intellect: 5, personality: 30, endurance: 13, accuracy: 7, speed: 12, luck: 7 },
  ...
  // ── Sorcerer line ────────────────────────────────────────────────────────
  {
    ...
    promotion: {
      ...
      giver: 'npc_sella_roon', location: 'millhaven_downs',
      requiredLevel: 8, fee: 0,
      requiredSkills: [{ skill: 'fire', mastery: E }, { skill: 'meditation', mastery: E }],
      summary: 'Retrieve the Ember chapter\'s stolen apprentice rolls from the goblin warren under the Old Watch.',
    },
  },
  {
    ...
    baseSP: 30, spPerLevel: 4, spStat: 'intellect', spStatFactor: 1,
    startingStats: { might: 5, intellect: 30, personality: 7, endurance: 12, accuracy: 12, speed: 13, luck: 7 },
      ...
      alternatives: [
        {
          ...
          giver: 'npc_the_unlisted', location: 'malveth_spires',
          requiredLevel: 22, fee: 0,
          requiredSkills: [{ skill: 'earth', mastery: M }, { skill: 'meditation', mastery: G }],
          summary: 'Prepare your own phylactery in the Tharn Vault and put your heart into it. Literally. Dark Magic itself is not taught until the working is done.',
        },
      ],
      giver: 'npc_nim_vellory', location: 'thornwick_vale',
      requiredLevel: 22, fee: 0,
      requiredSkills: [{ skill: 'fire', mastery: G }, { skill: 'learning', mastery: M }],
      summary: 'Sit the Archmage examination: answer the Concord\'s four questions, one per element.',
    },
  },
  {
    ...
    description: 'The Concord\'s highest chair. Archmages are the only mortals in Caerwen who can call Divine Intervention and Incinerate in the same afternoon.',
    hitDie: 6, baseHP: 21, hpPerLevel: 4, enduranceFactor: 1,
    baseSP: 44, spPerLevel: 5, spStat: 'intellect', spStatFactor: 2,
    startingStats: { might: 5, intellect: 30, personality: 7, endurance: 12, accuracy: 12, speed: 13, luck: 7 },
  ...
  // ── Ranger line ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Border scouts who learned enough hedge-magic to winter alone in the Malveth Spires.',
    ...
    promotion: {
      ...
      giver: 'npc_corb_quay', location: 'saltmarch',
      requiredLevel: 8, fee: 0,
      requiredSkills: [{ skill: 'perception', mastery: E }, { skill: 'bow', mastery: E }],
      summary: 'Track and take the white hart of the far bank without loosing more than one arrow.',
    },
  },
  {
    ...
    promotion: {
      ...
      summary: 'Walk the Saltmarch sea wall end to end, clearing every harpy roost on it.',
    },
  },
  {
    ...
    description: 'Wardens of the wild marches. A Ranger Lord can cross the Riven Steppe in winter and come back fatter than they left.',
    hitDie: 10, baseHP: 30, hpPerLevel: 7, enduranceFactor: 2,
  ...
  // ── Monk line ────────────────────────────────────────────────────────────
  {
    ...
    description: 'Trained in the sea cloisters above the Saltmarch. A monk in a robe outfights a knight in plate, given enough years.',
    ...
    promotion: {
      ...
      giver: 'npc_old_hessa', location: 'brackwater_isle',
      requiredLevel: 8, fee: 0,
      requiredSkills: [{ skill: 'unarmed', mastery: E }, { skill: 'dodging', mastery: E }],
      summary: 'Fast three days on Brackwater Isle and best Hessa\'s three students without a weapon.',
    },
  },
  {
    ...
    promotion: {
      ...
      giver: 'npc_old_hessa', location: 'the_whitemantle',
      requiredLevel: 20, fee: 0,
      requiredSkills: [{ skill: 'unarmed', mastery: G }, { skill: 'staff', mastery: G }],
      summary: 'Climb the Whitemantle to the wind shrine and return with Hessa\'s answer, which is one word long.',
    },
  },
  {
    id: 'master', name: 'Master', base: 'monk', tier: 2,
    promotesTo: [],
    role: 'Final Monk form. Grandmaster unarmed, staff, dodging and conditioning at once.',
  ...
  // ── Thief line ───────────────────────────────────────────────────────────
  {
    ...
    description: 'Saltmarch produces two things in quantity: shipping contracts and people who steal them. No magic, but no locked chest either.',
    ...
    promotion: {
      ...
      giver: 'npc_pell_marrow', location: 'saltmarch',
      requiredLevel: 8, fee: 0,
  ...
  },
  {
    ...
    promotion: {
      ...
      giver: 'npc_pell_marrow', location: 'duskorn_waste',
      requiredLevel: 20, fee: 0,
      requiredSkills: [{ skill: 'stealing', mastery: G }, { skill: 'perception', mastery: G }],
      summary: 'Get inside the Choir Hall\'s inner hall at Duskorn, copy the roll, and leave without a single alarm.',
    },
  },
  {
    ...
    description: 'On the crown\'s books as a clerk. Every court in Caerwen has one and none of them will say so.',
